...
public class Role implements GenericEntity<RoleDTO> {
    ...
    @Override
    public void readDTO(RoleDTO roleDTO) {
        this.id = roleDTO.getId();
        this.name = roleDTO.getName();
        this.persons = roleDTO.getPersons();
        this.contracts = roleDTO.getContracts();
    }
